 ...
 * (720x720 MIPI DSI, capacitive touch) with LVGL rendering at a logical
 * 480x480 that the PPA scales up.  Replace the body of ui_init() with your own
 * widgets.
 *
 ...
 * display size, so this same file works at 480x480 here and at the native
 * 720x720 in the sibling chipguy_P486Panel_display library.
 *
...
void ui_init(void) {
    ...
    // Color-test rectangle near the top.  The 3/4 x 7/24 proportions give the
    // familiar 360x140 at this library's logical 480x480.
